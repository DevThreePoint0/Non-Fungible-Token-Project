...
function App() {
	...
	const loadBlockchainData = async (_web3, _account, _networkId) => {
		...
		try {
			...
			setRevealTime((Number(timeDeployed) + Number(allowMintingAfter)).toString() + '00')
				...
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						<Col xs={12} md={12} lg={8} xxl={8}>
							<h1>Open Punks</h1>
							<p className='sub-header'>Availble on 8 / 17 / 23</p>
						</Col>
						<Col className='flex social-icons'>
							<a
								href="https://twitter.com/DevThreePoint0"
								target='_blank'
								className='circle flex button'>
								<img src={twitter} alt="Twitter" />
							</a>
							<a
								href="https://github.com/DevThreePoint0"
								target='_blank'
								className='circle flex button'>
